              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php
                    $counter=1;
                    $get_event=$goodideas->query("SELECT * FROM users where account_type = 2");
                      ...
                      ?>
                        <tr>
                          ...
                          <td data-title="Action" style="display: flex;justify-content: space-evenly;">
                            ...
                            <form action="member_profile.php" method="post" class="action_form_buttons">
                              <input type="hidden" name="member_id" value="<?php echo $get_event_row['id'];?>">
